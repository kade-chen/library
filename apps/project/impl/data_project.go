...
func (s *service) QueryByProjectAllQueryByDateProjectAll(ctx context.Context, config *model.ProjectDataConfig) ([]model.ProjectDateCost, error) {
	...
	var results []model.ProjectDateCost
	for {
		var row model.ProjectDateCost
		err := it.Next(&row)
...
// 2.自定义查询
// 2.1 全部service，指定sku
func (s *service) QueryByDateProjectServicesCustomSku(ctx context.Context, config *model.ProjectDataConfig) ([]model.ProjectDateCost, error) {
	// startDate := "2025-10-01"
	// endDate := "2025-10-02"
	// projectIDs := []string{} // 空数组表示查询全部项目
	// projectIDs := []string{"yz-bx3-prod", "kade-poc", "zzshushu"} // 指定项目
...
// 2.自定义查询
// 2.2 指定service，全sku
func (s *service) QueryByDateProjectCustomServicesAllSkus(ctx context.Context, config *model.ProjectDataConfig) ([]model.ProjectDateCost, error) {
	// startDate := "2025-10-01"
	// endDate := "2025-10-02"
	// projectIDs := []string{} // 空数组表示查询全部项目
	// projectIDs := []string{"yz-bx3-prod", "kade-poc", "zzshushu"} // 指定项目
...
// 2.自定义查询
// 2.2 指定service，指定sku
func (s *service) QueryByDateProjectCustomServicesCustomSkus(ctx context.Context, config *model.ProjectDataConfig) ([]model.ProjectDateCost, error) {
	// startDate := "2025-10-01"
	// endDate := "2025-10-02"
	// projectIDs := []string{} // 空数组表示查询全部项目
	// projectIDs := []string{"yz-bx3-prod", "kade-poc", "zzshushu"} // 指定项目
