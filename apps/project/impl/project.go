...
func (s *service) QueryByProjectAll(ctx context.Context, config *model.ProjectDataConfig) ([]model.ProjectCost, error) {
...
// 2.自定义查询
// 2.1 全部service，指定sku
func (s *service) QueryByProjectServicesCustomSku(ctx context.Context, config *model.ProjectDataConfig) ([]model.ProjectCost, error) {
	// startDate := "2025-10-01"
	// endDate := "2025-10-02"
	// projectIDs := []string{} // 空数组表示查询全部项目
	// projectIDs := []string{"yz-bx3-prod", "kade-poc", "zzshushu"} // 指定项目
	...
	// 构造查询
	sql := s.queryByProjectServicesCustomSkusSQL()
	q := s.bq.Query(sql)
...
// 2.自定义查询
// 2.2 指定service，全sku
func (s *service) QueryByProjectCustomServicesAllSkus(ctx context.Context, config *model.ProjectDataConfig) ([]model.ProjectCost, error) {
	// startDate := "2025-10-01"
	// endDate := "2025-10-02"
	// projectIDs := []string{} // 空数组表示查询全部项目
	// projectIDs := []string{"yz-bx3-prod", "kade-poc", "zzshushu"} // 指定项目
	...
	// 构造查询
	sql := s.queryByProjectCustomServicesAllSkusSQL()
	q := s.bq.Query(sql)
...
// 2.自定义查询
// 2.2 指定service，指定sku
func (s *service) QueryByProjectCustomServicesCustomSkus(ctx context.Context, config *model.ProjectDataConfig) ([]model.ProjectCost, error) {
	// startDate := "2025-10-01"
	// endDate := "2025-10-02"
	// projectIDs := []string{} // 空数组表示查询全部项目
	// projectIDs := []string{"yz-bx3-prod", "kade-poc", "zzshushu"} // 指定项目
	...
	// 构造查询
	sql := s.queryByProjectCustomServicesCustomSkusSQL()
	q := s.bq.Query(sql)
