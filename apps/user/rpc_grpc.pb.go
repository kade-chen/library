...
const (
	RPC_ListUser_FullMethodName     = "/kade_chen.google_billing_console.user.RPC/ListUser"
	RPC_DescribeUser_FullMethodName = "/kade_chen.google_billing_console.user.RPC/DescribeUser"
)
...
type RPCClient interface {
	// 查询用户列表
	ListUser(ctx context.Context, in *QueryUserRequest, opts ...grpc.CallOption) (*UserSet, error)
	// 查询用户详情
...
func (c *rPCClient) ListUser(ctx context.Context, in *QueryUserRequest, opts ...grpc.CallOption) (*UserSet, error) {
	out := new(UserSet)
...
type RPCServer interface {
	// 查询用户列表
	ListUser(context.Context, *QueryUserRequest) (*UserSet, error)
	// 查询用户详情
...
func (UnimplementedRPCServer) ListUser(context.Context, *QueryUserRequest) (*UserSet, error) {
...
func _RPC_ListUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RPCServer).ListUser(ctx, req.(*QueryUserRequest))
	}
...
var RPC_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kade_chen.google_billing_console.user.RPC",
	...
	Metadata: "google-billing-console/apps/user/pb/rpc.proto",
}
