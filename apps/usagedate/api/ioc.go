...
type ApiHandler struct {
	ioc.ObjectImpl
	log      *zerolog.Logger
	project  usagedate.ProjectService
	service  usagedate.Service
	sku      usagedate.SkuService
	labelkey usagedate.LabelKeyService
...
func (u *ApiHandler) Registry() {
	...
	ws.Route(ws.POST("/labels-keys").To(u.byAllLabelKeyHandler).
