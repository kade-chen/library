...
func (s *service) QueryByUsageDatProjectLabelKeyAll(ctx context.Context, config *model.UsageDateProjectLabelKeyRequest) (model.UsageDateProjectLabelKeyLists, error) {
	...
	ctx = context.WithValue(context.Background(), "trances_id", trancesID)
	...
	if err != nil {
		...
		return model.UsageDateProjectLabelKeyLists{}, exception.NewInternalServerError("trances_id=%s, Failed to execute query: %v", trancesID, err)
	}
	...
	for {
		...
		if err != nil {
			...
			return model.UsageDateProjectLabelKeyLists{}, exception.NewInternalServerError("trances_id=%s, Failed to iterate over query results: %v", trancesID, err)
		}
...
func (s *service) mergeLabelKeyLists(ctx context.Context, list []model.UsageDateProjectLabelKeyList) model.UsageDateProjectLabelKeyLists {
