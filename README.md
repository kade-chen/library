#### Links
- [Setup one](https://pkg.go.dev/github.com/kade-chen/library/v1/tree/v1.2.14)
- [Setup two](https://pkg.go.dev/github.com/kade-chen/library/tree/v1/v1.2.14)
- [Setup three](https://pkg.go.dev/github.com/kade-chen/library/v1@v1.2.14)
...
```go
 ...
 git push -f https://github.com/kade-chen/library.git v1.2.14 cobra command successful

https://pkg.go.dev/github.com/kade-chen/library/tree/v1.2.14 这个没啥用

https://pkg.go.dev/github.com/kade-chen/library@v1.2.14

https://pkg.go.dev/github.com/kade-chen/library/v1@v1.2.14  目前只需要apply这个就行了

备注：https://deps.dev/go/github.com%2Fkade-chen%2Flibrary/v1.2.14/versions
如果不知道版本可以从这里看

1. https://proxy.golang.org/github.com/kade-chen/library/@v/v1.2.14.info
...
```go
{
  ...
  "Origin": {
    ...
    "Ref": "refs/tags/v1.2.14"
  }
}
```
2. https://proxy.golang.org/github.com/kade-chen/library/@v/v1.2.14.mod
