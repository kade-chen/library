#### Links
- [Setup one](https://pkg.go.dev/github.com/kade-chen/library/v1/tree/v1.0.9)
- [Setup two](https://pkg.go.dev/github.com/kade-chen/library/tree/v1/v1.0.9)
- [Setup three](https://pkg.go.dev/github.com/kade-chen/library/v1@v1.0.9)
...
```go
 ...
 git push -f https://github.com/kade-chen/library.git v1.0.9 cobra command successful

https://pkg.go.dev/github.com/kade-chen/library/tree/v1.0.9 这个没啥用

https://pkg.go.dev/github.com/kade-chen/library@v1.0.9

https://pkg.go.dev/github.com/kade-chen/library/v1@v1.0.9  目前只需要apply这个就行了

备注：https://deps.dev/go/github.com%2Fkade-chen%2Flibrary/v1.0.9/versions
如果不知道版本可以从这里看
