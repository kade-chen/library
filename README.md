#### Links
- [Setup one](https://pkg.go.dev/github.com/kade-chen/library/v1/tree/v1.1.4)
- [Setup two](https://pkg.go.dev/github.com/kade-chen/library/tree/v1/v1.1.4)
- [Setup three](https://pkg.go.dev/github.com/kade-chen/library/v1@v1.1.4)
...
```go
 ...
 git push -f https://github.com/kade-chen/library.git v1.1.4 cobra command successful

https://pkg.go.dev/github.com/kade-chen/library/tree/v1.1.4 这个没啥用

https://pkg.go.dev/github.com/kade-chen/library@v1.1.4

https://pkg.go.dev/github.com/kade-chen/library/v1@v1.1.4  目前只需要apply这个就行了

备注：https://deps.dev/go/github.com%2Fkade-chen%2Flibrary/v1.1.4/versions
如果不知道版本可以从这里看
