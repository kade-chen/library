...
```go
 ...
 git push -f https://github.com/kade-chen/library.git v1.0.6 cobra command successful

https://pkg.go.dev/github.com/kade-chen/library/tree/v1.0.6

https://pkg.go.dev/github.com/kade-chen/library@v1.0.6

 #https://pkg.go.dev/github.com/kade-chen/library/v1/tree/v1.0.6

 #https://pkg.go.dev/github.com/kade-chen/library/tree/v1/v1.0.6
